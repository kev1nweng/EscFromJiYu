...
class homochatter:
    def run(inputNum):
        ...
        tips = [
            "猜猜最多可以输入几位数（喜",
            "HomoChatter的开发者头发已经只剩十根甚至是九根力（悲",
            "震惊！今日一名为HomoChatter的人机聊天软件成功通过图灵测试！",
            "冷知识：输入的不是整数不会真的被撅（心虚",
            "我现在就要和HomoChatter聊天，三回啊三回",
            "假如HomoChatter在Github上开源会发生什么？",
            "据报道，我校homo浓度已达到惊人的114%",
            "学校食堂的秘制酱料面很好吃，赶紧去尝尝（喜",
            "homo特色社会主义",
            "近日，两学生在教室里公然开撅",
        ]
